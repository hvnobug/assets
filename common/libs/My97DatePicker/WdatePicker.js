...
(function () {
    ...
    A = 'https://cdn.jsdelivr.net/gh/hvnobug/assets/common/libs/My97DatePicker/' || L();
    ...
    function U(J, C) {
        ...
        if (C) {
            ...
            if (!J.el || J.el["My97Mark"] === true || J.el.disabled || (J.el == $dp.el && Q($dp.dd) != "none" &&
                    $dp.dd.style.left != "-1970px")) {
                J.el["My97Mark"] = false;
                return
            }
            K(J);
    ...
    function K(H, $) {
        ...
        if ($ || $dp.eCont || new RegExp(/input|textarea|div|span|p|a/ig).test(E)) $dp.elProp = E == "INPUT" ?
            "value" : "innerHTML";
        else return;
        if ($dp.lang == "auto") $dp.lang = T ? navigator.browserLanguage.toLowerCase() : navigator.language.toLowerCase();
        if (!$dp.dd || $dp.eCont || ($dp.lang && $dp.realLang && $dp.realLang.name != $dp.lang && $dp.getLangIndex &&
                $dp.getLangIndex($dp.lang) >= 0)) {
        ...
        function C() {
            ...
            if (isNaN(B)) {
                ...
                else B = A.top + $.topM + Math.min(H.bottom, D.height - E);
                B += T ? -1 : 1
            } else B += A.top + $.topM;
